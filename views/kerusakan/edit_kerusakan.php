          ...
          <div class="layout-content-body">
            <div class="title-bar">
                <h1 class="title-bar-title">
                    <span class="d-ib">Kerusakan / Edit</span>
                    <span class="d-ib">
              ...
              <div class="col-md-8">
                <div class="demo-form-wrapper">
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                     <input type="text" hidden="" name="id" value="<?= $kerusakan['id'];?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          <?php foreach($subarea as $s)
                                    { 
                              ?>
                                <?php if($kerusakan['id_subarea'] == $s['id']): ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input id="form-control-1" class="form-control" type="text" placeholder="Isi Kerusakan" name="kerusakan" value="<?= $kerusakan['kerusakan']; ?>" required>
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input id="form-control-1" class="form-control" type="text" placeholder="Isi Pelapor" name="follow_up" value="<?= $kerusakan['follow_up']; ?>" required>
                          <small class="form-text text-danger"><?= form_error('follow_up');?></small>
                        </div>
                  </div>
                  <div class="form-group">
                          <label class="col-sm-3 control-label" for="form-control-6">Status* required</label>
                          <div class="col-sm-9">
                            <select id="form-control-6" class="form-control" name="status">

                            <?php foreach($status as $j): ?>
                                <?php if($j == $kerusakan['status']): ?>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                      <img src="<?= base_url('assets/upload/kerusakan/') . $kerusakan['image']; ?>" alt="" width="100" height="100"><br><br><input type="file" name="image" id="image">
                        <p class="help-block">
