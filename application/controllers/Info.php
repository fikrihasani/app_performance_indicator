...
class Info extends CI_Controller{
    ...
    public function getData(){
        $tmp = $this->db->query("select avg(pemeriksaan.hasil)*100 as nilai,area.nama from pemeriksaan inner join area on pemeriksaan.id_area=area.id group by pemeriksaan.id_area");
        ...
        foreach($tmp->result_array() as $row){
          ...
          // array_push($data['performance'],array('x'));
        }
