...
Class Doctor extends CI_Controller {
    ...
    public function user_input() {
        ...
        $subdata['hasil']           = $this->db->query("SELECT id_desa, nama_desa FROM desa where id_desa NOT IN (SELECT DISTINCT desa.id_desa from user join desa ON user.id_desa = desa.id_desa)")->result_array();
    ...
    public function user_edit($id = ''){
        ...
        if ($id != '') {
            ...
            $subdata['desa_user'] = $this->db->query("SELECT DISTINCT id_desa FROM user WHERE id_desa <> 99 and id_desa IS NOT NULL")->result_array();
