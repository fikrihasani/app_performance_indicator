...
class Sca_Dokumentasi extends CI_Controller{
    ...
    public function index(){
        ...
        $data['sca_dokumentasi'] = $this->db->query(" select b.nama as area, c.nama as subarea, a.shift, a.nilai, a.user, a.id, a.time, a.image
            from sca_dokumentasi a
            left join area b on a.area=b.id
            left join subarea c on a.sub_area=c.id order by a.id desc")->result_array();
    ...
    function cetak(){
        ...
        if($enddate < $startdate) {
            ...
            $data['sca_dokumentasi'] = $this->Sca_Dokumentasi_Model->getAllSca();;
            $data['tgl1'] = $startdate;
            $data['tgl2'] = $enddate;
