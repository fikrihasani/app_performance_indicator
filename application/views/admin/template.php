...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url('home/user_edit/').$user['id_user'];?>" class="btn btn-default btn-flat">Profile</a>
                </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
		  ...
		  <ul class="treeview-menu">
            <li><a href="<?php echo site_url('home/user_input');?>"><i class="fa fa-circle-o"></i>Tambah Pengguna Baru</a></li>
            <li><a href="<?php echo site_url('home/user_daftar');?>"><i class="fa fa-circle-o"></i>Daftar Pengguna</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i>Kehamilan Tahun Berjalan</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/tables/simple.html"><i class="fa fa-circle-o"></i>Kehamilan Berjalan</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="http://if.undip.ac.id.com">Ilmu Komputer Universitas Diponegoro</a>.</strong> All rights
    reserved.
  </footer>
