            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo site_url('home/keluar');?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="<?php echo site_url('home/user_daftar');?>">
            <i class="fa fa-book"></i>
            <span>Data Belum Terverifikasi</span>
          </a>
        </li>
        <li class="treeview">
          <a href="#">
