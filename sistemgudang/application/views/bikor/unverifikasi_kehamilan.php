...
<section class="content">
	...
	<form action="<?php echo $action;?>" method="POST" class='form-horizontal'>
		...
		<div class="box-footer">
            <b >
			<a href='<?php echo site_url('checkup/kehamilan_unverified_detail/'.simple_encrypt($get['id_kehamilan']));?>' class='btn btn-small btn-danger' >Batalkan</a>
            </b >
			<button type="submit" class="btn btn-success pull-right" onClick=\"return confirm('Anda yakin ingin mengubah status data ini ?')\">Ubah Status</button>
        </div>
	</form>
	</div>
</section>