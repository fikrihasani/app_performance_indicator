	...
	<div class="box box-default">
		...
		<div class="box-body with-border">
			...
			<div class="row">
                  ...
                  <div class="col-sm-10" >
					<a>:</a><?php echo $ibu['nama_ibu'].' / '.$ibu['nik'];?>
                  </div>
            </div>
			<div class="row">
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-10">
					<a>:</a><?php echo empty_convert($h['catatan']); ?>
                  </div>
            </div>
		</div>
	</div>
	...
	<div class="box box-default">
		...
		<div class="box-body with-border">				
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="number" placeholder="Angka" name='berat_badan' onchange="setTwoNumberDecimal" step="0.1" min="1" max="300" class="form-control" style="width:100px;" value="<?php echo (ISSET($h['berat_badan']))? $h['berat_badan'] : '0.0'; ?>">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Tinggi Badan(Cm)</label>
				<div class="col-sm-10">
					<input type="number"placeholder="Cm" name='tinggi_badan' onchange="setTwoNumberDecimal" step="0.1" min="1" max="300" class="form-control" style="width:100px;" value="<?php echo (ISSET($h['tinggi_badan']))? $h['tinggi_badan'] : '0.0'; ?>">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="number" onchange="setTwoNumberDecimal" placeholder="Cm" name='lingkar_lengan' min="0" max="100" step="0.1" class="form-control" style="width:100px;" value="<?php echo (ISSET($h['lingkar_lengan']))? $h['lingkar_lengan'] : '0.0'; ?>">
				</div>
			</div>
			<div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <label>
                        <input type="radio"  name="status_gizi" value ='0' class="flat-red"   <?php echo (ISSET($h['status_gizi']) && $h['status_gizi'] == '0' )? 'checked' : ''; ?>  >Cukup Gizi
                        </label>
                  </div>
				  <div class="col-sm-2">
					<label>
	...
	<div class="box box-default">
		...
		<div class="box-body with-border">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="number" placeholder="X/menit" name='djj' min="0" max="999" class="form-control" style="width:100px;" value="<?php echo (ISSET($h['djj']))? $h['djj'] : ''; ?>">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="number" placeholder="gr" name='berat_janin' min="0" max="9999" class="form-control" style="width:100px;" value="<?php echo (ISSET($h['berat_janin']))? $h['berat_janin'] : ''; ?>">
				</div>
			</div>
			<div class="form-group">
