<section class="content">
	...
	<div class="box box-default">
		...
		<div class="box-footer">
			...
			<?php
				if (is_auth(2)){
					echo"<a href='".site_url('checkup/kehamilan_unverified_edit/')."/".simple_encrypt($get['id_kehamilan'])."' class='btn btn-small btn-success' >Ubah Data</a>";
				}else if (is_auth(3)){
						echo"<a href='".site_url('analysist/unverifikasi_kehamilan/')."/".simple_encrypt($get['id_kehamilan'])."' class='btn btn-small btn-warning'>Periksa Kembali</a>";
