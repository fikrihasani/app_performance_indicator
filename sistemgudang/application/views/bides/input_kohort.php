...
<section class="content">
	...
	<div class="box box-default">
		...
		<div class="box-body with-border">
			<div class="form-group">
				<label for="input-group" class="col-sm-2 control-label">Tanggal Periksa</label>
				<div class="col-sm-10">
					<div class="input-group">
						<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
						<input type="date" name="tanggal_periksa" class="form-control datemask datepicker" inputmask="'alias': 'dd/mm/yyyy'" style="max-width:130px;" value="<?php echo (ISSET($last['tanggal_periksa']))? $last['tanggal_periksa'] : ''; ?>">
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<label for="input-group" class="col-sm-2 control-label">Waktu Konsepsi</label>
				<div class="col-sm-10">
					<div class="input-group">
						<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
						<input type="date" name="waktu_konsepsi" class="form-control datemask datepicker" inputmask="'alias': 'dd/mm/yyyy'" style="max-width:130px;" value="<?php echo (ISSET($last['waktu_konsepsi']))? $last['waktu_konsepsi'] : ''; ?>">
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<div class="input-group">
						<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
						<input type="date" name="HPL" class="form-control datemask datepicker" inputmask="'alias': 'dd/mm/yyyy'" style="max-width:130px;" value="<?php echo (ISSET($last['HPL']))? $last['HPL'] : ''; ?>">
					</div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-1">
					<input type="number"  onchange="setTwoNumberDecimal" placeholder="Angka" name='berat_badan' min="1" max="400" step="0.1" class="form-control" style="width:100px;" value="<?php echo (ISSET($last['berat_badan']))? $last['berat_badan'] : '0.0'; ?>">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Tinggi Badan(Cm)</label>
				<div class="col-sm-10">
					<input type="number"placeholder="Cm" name='tinggi_badan' onchange="setTwoNumberDecimal" min="1" max="400" step="0.1" class="form-control" style="width:100px;" value="<?php echo (ISSET($last['tinggi_badan']))? $last['tinggi_badan'] : '0.0'; ?>">
				</div>
			</div>
			<div class="form-group">
		...
		$(document).ready(function(){
			$("#id_ibu").change(function(){
				...
				$.ajax({
					method      : 'GET',
                    dataType    : 'json',
					url         : '<?php echo site_url('patient/ajax_ibu/');?>/' + id_ibu,
					data        : "",
	...
	<script>
	$( "#datepicker" ).datepicker( { minDate: -0, maxDate: new Date(2018, 1,17) });
	</script>
</section>
<!-- ./ End Content-->
