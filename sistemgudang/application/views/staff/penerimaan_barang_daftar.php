<form action="<?php echo site_url('barang/source_penerimaan_daftar'); ?>" id='display-table'>
<!-- Main content -->
<section class="content">
    <div class="row">
			<a href="<?php echo site_url('barang/penerimaan_input');?>"class="btn btn-primary ml-15">
			<i class="fa fa-box"></i> Tambah Barang Datang Baru
			</a><br><br>
        <div class="col-xs-12">			
            <div class="box">
                    ...
                    <table id="listed-table" class="table table-bordered table-striped mb-20" >
                        <thead>
                            <tr>
                                ...
                                <th class="text-left">Nama Shipper</th>
                                <th class="text-left">Forwarder</th>
                                <th class="text-left">Jumlah (Koli)</th>
