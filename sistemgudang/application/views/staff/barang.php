<form action="<?php echo site_url('barang/source_barang_daftar'); ?>" id='display-table'>
<!-- Main content -->
<section class="content">
    <div class="row">
			<a href="<?php echo site_url('barang/barang_input');?>"class="btn btn-primary ml-15">
			<i class="fa fa-box"></i> Tambah Barang Baru
			</a><br><br>
        <div class="col-xs-12">			
            <div class="box">
                ...
                <div class="box-body" style="display: block;">
                    <div class='col-md-6'>
                        ...
                        <div class="form-group">
                          ...
                          <select name='id_kategori'  class="form-control" style="width:150px;">
