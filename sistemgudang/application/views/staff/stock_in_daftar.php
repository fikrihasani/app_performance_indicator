...
<section class="content">
    <div class="row">
			<a href="<?php echo site_url('barang/stock_in_input');?>"class="btn btn-primary ml-15">
			<i class="fa fa-box"></i> Tambah Stock In
			</a><br><br>
        <div class="col-xs-12">			
            <div class="box">
            ...
            <div class="box">
				<div class="box-header with-border">
                  <h3 class="box-title">Riwayat Barang Masuk</h3>
                    ...
                    <table id="listed-table" class="table table-bordered table-striped mb-20" >
                        <thead>
                            <tr>
                                ...
                                <th class="text-left">Lokasi Penyimpanan</th>
