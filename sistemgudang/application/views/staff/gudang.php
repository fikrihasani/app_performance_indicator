<form action="<?php echo site_url('barang/source_gudang_daftar'); ?>" id='display-table'>
<!-- Main content -->
<section class="content">
    <div class="row">
			<a href="<?php echo site_url('barang/gudang_input');?>"class="btn btn-primary ml-15">
			<i class="fa fa-box"></i> Tambah Gudang Baru
			</a><br><br>
        <div class="col-xs-12">			
            <div class="box">
                    ...
                    <table id="listed-table" class="table table-bordered table-striped mb-20" >
                        <thead>
                            <tr>
                                ...
                                <th class="text-left">Nama Alamat</th>
