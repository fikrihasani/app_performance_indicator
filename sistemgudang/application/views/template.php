...
<head>
  ...
  <title>APS Inventory Sistem | <?php echo $meta_title; ?></title>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p><?php echo full_name();?>
                  <small>
						<?php 
							echo "Terdaftar Sejak ".date_convert(get_date($user['create_date'])); 
						?>
				  </small>
                </p>
              </li>
              ...
              <li class="user-footer">
				<div class="btn-group">
					<a href="<?php echo site_url('admin/user_edit/').simple_encrypt($user['id_user']);?>" class="btn btn-default btn-flat">Profile</a>
					<a href="<?php echo site_url('admin/password_update/').simple_encrypt($user['id_user']);?>" class="btn btn-default btn-flat">Ubah Password</a>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?php 
					if (level() == 1){echo base_url('assets/image/aps160x160.png');}
					else if (level() == 2){echo base_url('assets/image/aps160x160.png');}
					else if (level() == 3){echo base_url('assets/image/aps160x160.png');}
					else if (level() == 4){echo base_url('assets/image/aps160x160.png');}
						...
						echo"
							<li class='treeview'>
								<a href='#'>
									...
									<span>Pengelolaan Inventory</span>
									<span class='pull-right-container'>
									  <i class='fa fa-angle-down pull-right'></i>
									</span>
								</a>
								<ul class='treeview-menu'>
									<li><a href='".site_url('barang/barang_daftar')."'>Daftar Barang</a></li>
									<li><a href='".site_url('barang/kategori_daftar')."'>Daftar kategori</a></li>
									<li><a href='".site_url('barang/gudang_daftar')."'>Daftar Gudang</a></li>
									<li><a href='".site_url('barang/penyimpanan_daftar')."'>Daftar Penyimpanan</a></li>
								</ul>
							</li>
							<li class='treeview'>
								<a href='#'>
								...
								<ul class='treeview-menu'>
									<li><a href='".site_url('barang/penerimaan_barang_daftar')."'>Penerimaan Barang</a></li>
									<li><a href='".site_url('barang/stock_in_daftar')."'>Stock In</a></li>
								</ul>
							</li>
							<li class='treeview'>
								<a href='#'>
								...
								<ul class='treeview-menu'>
									<li><a href='".site_url('barang/stock_out_daftar')."'>Stock Out</a></li>
									<li><a href='".site_url('checkup/rujukan_berjalan_daftar')."'>Pending Request</a></li>
								</ul>
							</li>
						";
					}
